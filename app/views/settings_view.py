...
def build_settings_view(
    ...
    # РІвЂќР‚РІвЂќР‚ Р СћР ВµР СР В° РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
    ...
    def on_address_blur(e):
        ...
        new_address = e.control.value.strip()
        config_manager.set_user_address(new_address)

        if new_address and new_address != previous_value:
            address_query = new_address
            ...
            if coordinates:
                config_manager.set_user_coordinates(coordinates[0], coordinates[1])
            else:
                _show_message("Адрес сохранен, но координаты обновить не удалось.")
    ...
    # РІвЂќР‚РІвЂќР‚ Р В¤Р В°Р С”РЎС“Р В»РЎРЉРЎвЂљР ВµРЎвЂљ РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
    ...
    # РІвЂќР‚РІвЂќР‚ Р РЋР С—Р С•РЎРѓР С•Р В± Р С—Р ВµРЎР‚Р ВµР Т‘Р Р†Р С‘Р В¶Р ВµР Р…Р С‘РЎРЏ РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
#     # РІвЂќР‚РІвЂќР‚ Р вЂќР С‘Р В°Р В»Р С•Р С– Р С‘Р СР С—Р С•РЎР‚РЎвЂљР В° РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
#     )
    ...
    def set_import_loading(is_loading: bool, status_text_value: str = ""):
        is_importing[0] = is_loading
        btn_confirm.disabled = is_loading or not bool(selected_file_path[0])
        btn_confirm.text = "Импортируем..." if is_loading else "Подтвердить импорт"
        progress.visible = is_loading
        import_status.value = status_text_value
        import_status.visible = is_loading
        btn_cancel.disabled = is_loading
        btn_import.disabled = is_loading
        navigation_bar.disabled = is_loading
        dialog.modal = True
    ...
    async def confirm_import(e):
        ...
        set_import_loading(True, "Импортируем файл...")
        page.update()
        await asyncio.sleep(0)

        try:
            import_path = get_schedule_storage_path().with_name("schedule_import.json")
            await asyncio.to_thread(parse_schedule_xlsx_file, selected_file_path[0], import_path)
    ...
    btn_cancel = ft.TextButton("Отмена", on_click = close_import_dialog)
    ...
    def close_about_dialog(dialog: ft.AlertDialog):
        dialog.open = False
        page.update()
                ...
                content = ft.Column(
                    [
                        ft.ExpansionTile(
                            ...
                            controls = [
                                ft.Container(
                                    ...
                                    content = ft.Column(
                                        [
                                            ft.Text("1. Добавьте расписание через импорт xlsx файла", size = 13),
                                            ft.Text("2. Настройте автобудильник в разделе 'Будильники'", size = 13),
                                            ft.Text("3. Укажите адрес и факультет для расчета маршрута", size = 13),
                                            ft.Text("4. Следите за задачами и событиями в планере", size = 13),
                                        ],
                                        spacing = 6,
                                    ),
                                ),
                        ...
                        ft.ExpansionTile(
                            ...
                            controls = [
                                ft.Container(
                                    ...
                                    content = ft.Column(
                                        [
                                            ft.Text("Используя это приложение, вы соглашаетесь:", size = 13),
                                            ft.Text("• Приложение показывает расписание, задачи и будильники.", size = 13),
                                            ft.Text("• Точность данных зависит от импортированного расписания.", size = 13),
                                            ft.Text("• Ваши данные хранятся локально на устройстве.", size = 13),
                                            ft.Text("• Приложение предоставляется 'как есть'.", size = 13),
                                        ],
                                        spacing = 6,
                                    ),
                                ),
                        ...
                        ft.ExpansionTile(
                            ...
                            subtitle = ft.Text("Информация о приложении", size = 12, color = ft.Colors.GREY_600),
                            controls = [
                                ft.Container(
                                    padding = ft.Padding.only(bottom = 12),
                                    content = ft.Column(
                                        [
                                            ft.Text(
                                                "University Planner помогает студентам организовать учебный процесс.",
                                                size = 13,
                                                italic = True,
                                            ),
                                            ft.Text(
                                                "Разработано для удобной работы с расписанием, задачами и событиями.",
                                                size = 13,
                                                italic = True,
                                            ),
                                            ft.Text("Версия: 0.1_beta", size = 13, weight = ft.FontWeight.W_500),
                                            ft.Text("© 2026 Все права защищены", size = 12, color = ft.Colors.GREY_600),
                                        ],
                                        spacing = 8,
                                    ),
                                ),
